...
LATER_TOOL_LINES = (
    ...
    "- excel_live.set_font (굵게/글꼴/크기/글자색. 머리글 굵게는 이것)\n"
    "- excel_live.convert_to_excel_table (이미 있는 데이터 범위를 Excel 표로 변환. 빈 격자 create_table과 다름)\n"
    "- excel_live.apply_formula_cf (값이 바뀌면 다시 평가되는 수식 조건부 서식)\n"
...
def build_planner_prompt(
    ...
    *,
    ...
    return (
        ...
        "- excel_live.rename_sheet (기존 시트 이름 변경. 열 이름 변경은 rename_column)\n"
        "- excel_live.delete_sheet (시트 삭제. 마지막 시트는 남김. 행 삭제가 아님)\n"
