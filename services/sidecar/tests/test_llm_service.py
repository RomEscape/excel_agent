...
def test_ollama_provider_uses_saved_model_config(monkeypatch, tmp_path):
    ...
    async def _fake_chat_messages(self, messages, model=None, temperature=None, json_only=False, json_schema=None, timeout=None):
...
# (test_claude_ignores_json_only... 는 Claude 경로 제거(dev 병합 2026-08-29)와 함께 폐기)
