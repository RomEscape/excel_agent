...
**입력 · 정리**
- 표를 붙여넣고 `여기에 입력해줘` (좌표를 칠 필요 없음)
- `A1:F6에 지역,주문건수,…; 수도권,10452,…; 충청권,… 입력` (세미콜론이 행 구분자)
...
전체 재현 각본(6개 데모 대시보드를 대화만으로 만드는 45~92턴)은 `docs/example*_재현_대화_*.md`,
사람 말투판·단축판은 `docs/example1_사람말투판_45턴.md`·`docs/example1_단축판_51턴.md`.
